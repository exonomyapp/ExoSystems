...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1064060777;

  static const kDefaultExternalLibraryLoaderConfig =
      ExternalLibraryLoaderConfig(
        stem: 'rust_lib_bridge_monitor',
...
abstract class RustLibApi extends BaseApi {
  Stream<double> crateApiBreathingPulseStream();
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Stream<double> crateApiBreathingPulseStream() {
    ...
    handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiBreathingPulseStreamConstMeta,
        argValues: [sink],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiBreathingPulseStreamConstMeta =>
      const TaskConstMeta(
        debugName: "breathing_pulse_stream",
        argNames: ["sink"],
      );
