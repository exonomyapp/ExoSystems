// =============================================================================
// sovereign_toast.dart — Animated Notification Overlay (Conscia Standard)
// =============================================================================
...
class SovereignToastOverlay extends ConsumerWidget {
  final Widget child;
  const SovereignToastOverlay({super.key, required this.child});
        ...
        Positioned(
          ...
          child: ConstrainedBox(
            ...
            child: Column(
              ...
              children: toasts.map((t) => SovereignToastCard(toast: t, scale: scale)).toList(),
            ),
          ),
        ),
      ],
...
class SovereignToastCard extends StatefulWidget {
  final ToastMessage toast;
  final double scale;
  const SovereignToastCard({super.key, required this.toast, required this.scale});

  @override
  State<SovereignToastCard> createState() => _SovereignToastCardState();
}

class _SovereignToastCardState extends State<SovereignToastCard> with SingleTickerProviderStateMixin {
