...
function(apply_cargokit target manifest_dir lib_name any_symbol_name)
    ...
    if (IS_ABSOLUTE "${manifest_dir}")
        set(CARGOKIT_FULL_MANIFEST_DIR "${manifest_dir}")
    else()
        set(CARGOKIT_FULL_MANIFEST_DIR "${CMAKE_CURRENT_SOURCE_DIR}/${manifest_dir}")
    endif()

    set(CARGOKIT_ENV
        "CARGOKIT_CMAKE=${CMAKE_COMMAND}"
        "CARGOKIT_CONFIGURATION=$<CONFIG>"
        "CARGOKIT_MANIFEST_DIR=${CARGOKIT_FULL_MANIFEST_DIR}"
